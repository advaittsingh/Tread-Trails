...
function SocialIcon({ label }: { label: SiteSocialProfile["label"] }) {
  const cls = "size-5";
  switch (label) {
    case "Instagram":
      return <InstagramGlyph className={cls} />;
    case "YouTube":
      return <YouTubeGlyph className={cls} />;
    case "LinkedIn":
      return <LinkedInGlyph className={cls} />;
    default:
      return null;
  }
}
    ...
    <footer className="relative border-t border-border/50">
      <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-12 md:grid-cols-[1.3fr_1fr_1fr]">
          ...
          <div>
            <p className="font-heading text-xs tracking-[0.35em] text-foreground uppercase">
              Explore
            </p>
