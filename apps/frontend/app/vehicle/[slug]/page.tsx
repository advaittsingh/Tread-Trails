...
import { getVehicleCms } from "@/lib/server/cms";
import {
  getVehicleBySlug,
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const cms = await getVehicleCms(params.slug);
  const description = excerptPlain(cms?.seoDescription || car.description, 165);
