...
import { escapeHtml } from "../../lib/email/escape-html.js";
import {
  emailProviderLabel,
  sendTransactionalEmail,
} from "../../lib/email/transactional.js";
...
export async function sendAdminEmail(req: AuthedRequest, res: Response) {
  ...
  return res.json({ ok: true, id: sent.id, provider: sent.provider });
}
